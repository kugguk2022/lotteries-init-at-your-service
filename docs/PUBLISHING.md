...
After CI and the TestPyPI rehearsal pass, create a GitHub release tagged `v0.1.0a3`. The production
...
PyPI versions are immutable. Publish fixes under a new version such as `0.1.0a4`.
